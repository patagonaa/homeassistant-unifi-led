...
COPY src/dotnet-homeassistant-mqtt-discovery/src/HomeAssistantDiscoveryHelper/HomeAssistantDiscoveryHelper.csproj /app/src/dotnet-homeassistant-mqtt-discovery/src/HomeAssistantDiscoveryHelper/
